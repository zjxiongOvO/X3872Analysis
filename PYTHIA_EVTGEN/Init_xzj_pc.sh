#!/bin/bash
export PYTHIA8DATA="/home/kaus/container/Evtgen/Evtgen/share/Pythia8/xmldoc"
...
PYTHIA8="/home/kaus/container/Evtgen"
if [ -d "$PYTHIA8" ]; then
    export PYTHIA8
else
...
EVTGEN_ROOT="/home/kaus/container/Evtgen"
...
ROOT_SETUP_SCRIPT="/home/kaus/container/Evtgen/ROOT/root/bin/thisroot.sh"
