...
#you should install some dependence first
...
INSTALL_PREFIX="/home/kaus/container/Evtgen/Evtgen"
# Location of the dependence
dependence="/home/kaus/container/dependence"

# you needn't change the following!!!!!!!
...
#BUILD_BASE="/home/xzj/workdir/evtgen"
BUILD_BASE="/home/kaus/container/Evtgen/Evtgen"
...
then
    cp $dependence/$HEPMC2TAR $BUILD_BASE/tarfiles/.
else
    cp $dependence/$HEPMC3TAR $BUILD_BASE/tarfiles/.
fi
cp $dependence/$PYTHIATAR $BUILD_BASE/tarfiles/.
cp $dependence/$PHOTOSTAR $BUILD_BASE/tarfiles/.
cp $dependence/$TAUOLATAR $BUILD_BASE/tarfiles/.
...
tar -xvf $BUILD_BASE/tarfiles/$PHOTOSTAR
tar -xvf $BUILD_BASE/tarfiles/$TAUOLATAR
...
then
    ...
    # ./configure --with-hepmc3=$INSTALL_PREFIX --prefix=$INSTALL_PREFIX
    make
    make install
