...
def ComputeMLEfficiency(Tree=[],MassCut=[0,0],BDTBkgCut=[0,1],BDTPromptCut=[0,1],BDTFDCut=[0,1]):
    ...
    for itree,tree in enumerate(Tree):
...
#                if(BDTBkgCut[0]<entry.model_output_0<BDTBkgCut[1] and BDTPromptCut[0]<entry.model_output_1<BDTPromptCut[1]):
